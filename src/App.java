public class App {
    ...
    public static void main(String[] args) {
        ...
        listaElectrodomesticos[0]=new Electrodomestico(200, "Verde", 'C', 56);
        listaElectrodomesticos[1]=new Lavadora(150, 30);
        listaElectrodomesticos[2]=new Television(500, 80, 'E', "negro", 10, false);
        listaElectrodomesticos[3]=new Electrodomestico();
        listaElectrodomesticos[4]=new Electrodomestico(150, "azul", 'C', 40);
        listaElectrodomesticos[5]=new Lavadora(300, "negro", 'A', 200, 17);
        listaElectrodomesticos[6]=new Television(250, 70);
        listaElectrodomesticos[7]=new Lavadora(400, "verde", 'B', 100, 15);
        listaElectrodomesticos[8]=new Television(200, 60, 'C', "naranja", 10, true);
